...
This note is a design checklist, not a hosted deployment recipe or a security certification. No hosted environment is supplied by this release. Start with [[MCP Identity and Network Boundaries]], [[Retry and Idempotency Contract]], [[Memory Scope and Retention]] and [[Traces Metrics and Privacy]].
