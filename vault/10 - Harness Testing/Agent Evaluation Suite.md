...
Convert [[False Passing Feature]] into a task specification with a final database assertion. Use [[Experiment Template]] to record trial outcomes, cost and stop reason. Execute live trials only when a model and budget are explicitly configured.
