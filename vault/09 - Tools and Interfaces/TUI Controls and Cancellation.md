...
A cancellation acknowledgment does not undo effects already committed. See [[Budgets and Termination]] for the worked exercise and primary-source context. This addition does not change the legacy provenance recorded in [[Source Coverage Index]].
