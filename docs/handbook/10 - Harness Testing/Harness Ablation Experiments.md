...
Fill [Experiment Template](../Templates/Experiment%20Template.md). Include raw run IDs, success numerator/denominator, stop reasons, elapsed time and cost. Re-run after model upgrades. Mark the experiment unexecuted until raw evidence exists.
...
- [Agent Evaluation Suite](Agent%20Evaluation%20Suite.md)
- [Reproducible Evaluation Environment](../04%20-%20Ground/Reproducible%20Evaluation%20Environment.md)
- [Budgets and Termination](../08%20-%20Agent%20Runtime/Budgets%20and%20Termination.md)
