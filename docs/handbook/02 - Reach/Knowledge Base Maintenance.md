...
Copy [Source Note Template](../Templates/Source%20Note%20Template.md) for one source used by your project. Name the supported claim and a review trigger. Run the repository’s documentation checker after changing a link. Separately inspect the cited section for semantic accuracy.
...
- [Source Register](../00%20-%20Start%20Here/Source%20Register.md)
- [Source Coverage Index](../00%20-%20Start%20Here/Source%20Coverage%20Index.md)
